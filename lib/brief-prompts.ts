...
function getWackyPrompt(category: string, wackyStyle: WackyBriefStyle): string {
  ...
  return [
    ...
    "- CRITICAL: Separate each section with a blank line (double newline)",
    ...
    "",
    "EXAMPLE OUTPUT FORMAT (notice the blank lines between sections):",
    "**Main Message**",
    ...
    '  "briefContent": string (bulleted with **bold** subheadings, blank lines between sections)',
    "}",
    "",
...
function getRealisticPrompt(category: string): string {
  return [
    ...
    "",
    "EXAMPLE FORMAT (notice the blank lines between sections):",
    "**Main Message**",
    "Never drink cold coffee again",
    "",
    "**What Is It**",
