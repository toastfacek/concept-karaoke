...
function getWackyPrompt(category: string, wackyStyle: WackyBriefStyle): string {
  ...
  return [
    ...
    "",
    "FORMAT REQUIREMENTS:",
    "- Write a prose brief that's 80-120 words total",
    "- Use quick, scannable sentences - NO long paragraphs",
    "- Structure with these markdown bold subheadings:",
    "  **What Is It** - 2-3 sentences describing the product form",
    "  **Who It's For** - 1-2 sentences about the target audience",
    "  **The Difference** - 2-3 sentences. " + styleInstructions.benefitGuidance,
    "  **Main Message** - 1-2 sentences. " + styleInstructions.messageGuidance,
    "",
...
function getRealisticPrompt(category: string): string {
  return [
    ...
    "- Use quick, scannable sentences - NO long paragraphs",
    "- Structure with these markdown bold subheadings:",
    "  **What Is It** - 2-3 sentences describing the product",
    "  **Who It's For** - 1-2 sentences about the target audience",
    "  **The Difference** - 2-3 sentences about what makes it unique",
    "  **Main Message** - 1-2 sentences with the core campaign message",
    "",
    "Respond with valid JSON matching this structure:",
    "{",
    '  "productName": string,',
    ...
    "",
    "**Who It's For**",
    "Young commuters and working professionals who are always on the go.",
    "",
    "**The Difference**",
    "Unlike standard travel mugs, Hearthco connects to your phone via Bluetooth to send appointment reminders when you pick it up.",
    "",
    "**Main Message**",
